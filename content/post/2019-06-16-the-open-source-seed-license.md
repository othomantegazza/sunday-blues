...
<!--
Same for open access publishing, who should pay the creators.

Over all impact good?

[Open access cost](https://www.mpg.de/9202262/area-wide-transition-open-access), looks like it's not big issue. But a couple of shortcomings: pay to publish, what if no fundings? More funded can publish more? Anyway publishing was expensive also without open access. Cooperative system possible (richest intitution pay for poorer?) Or state funded systems.

Great example, but issue of payment of author still there. Universities, is public service. 

Great example but main issue still there? No? Grants to open knowledge? State intervention required?

https://en.wikipedia.org/wiki/Article_processing_charge#cite_note-21

# The Open Source Seed License

No real data yet to tell if it's having impact on the seed market.

Likely a license will not be enough as the open source software shows, or the open access knowledge world shows. But it can be a part of it. and it can be a stepping stone to the right path.
